...
This repository contains the 1.1.0 specification, reference documentation, a JSON Schema validator, and example model files.

## Start Here

- Read the documentation index in [docs/index.md](./docs/index.md).
- Read the normative spec in [spec/cmmf-v1.1.0.md](./spec/cmmf-v1.1.0.md).
